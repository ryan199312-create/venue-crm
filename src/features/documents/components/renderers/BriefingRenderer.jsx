...
export const BriefingRenderer = ({ data, printMode, appSettings }) => {
  ...
  return (
    <div className="font-sans text-slate-900 w-full max-w-[210mm] print:max-w-none mx-auto bg-white p-[10mm] print:p-0 min-h-[297mm] print:min-h-0 shadow-sm print:shadow-none relative flex flex-col text-sm leading-relaxed">
      ...
      <DocumentHeader data={data} typeEn="BRIEFING" typeZh="樓面工作單" appSettings={appSettings} />
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="border-2 border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="p-3 space-y-3">
              ...
              <div className="flex justify-between items-center text-xs"><span className="font-bold text-slate-600">Parking:</span><span className="font-bold bg-slate-100 px-2 py-0.5 rounded">{(data.parkingInfo?.ticketQty) || 0} Tickets ({(data.parkingInfo?.ticketHours) || 0} hrs)</span></div>
            </div>
          </div>
          <div className="border-2 border-slate-200 rounded-xl overflow-hidden">
